...
def test_sub_region_ids():
    ...
    sub_regions_with_errors, correct_names = zip(*sub_regions_with_errors_mapped_to_correct_names.items())
...
def test_generator_names():
    ...
    generators_with_errors, correct_names = zip(*generators_with_errors_mapped_to_correct_names.items())
    matches = _fuzzy_match_names(
...
def test_abstract_to_non_exact_best_match_gets_priority():
    abstract_mapping = {
        'a': 'a',
        'b': 'b',
        'testng': 'testing',
...
def test_abstract_threshold_no_match():
...
def test_abstract_run_out_of_choices():
