...
def test_add_snapshot_weightings_two_investment_periods(csv_str_to_df):
    ...
    2026,                2026-01-01 01:00:00
    2026,                2026-01-01 02:00:00
    2026,                2026-01-01 03:00:00
    2026,                2026-01-01 04:00:00
    2028,                2028-01-01 01:00:00
    2028,                2028-01-01 02:00:00
    """
    ...
    2026,                2026-01-01 01:00:00,     2190.0,     2190.0,      1.0
    2026,                2026-01-01 02:00:00,     2190.0,     2190.0,      1.0
    2026,                2026-01-01 03:00:00,     2190.0,     2190.0,      1.0
    2026,                2026-01-01 04:00:00,     2190.0,     2190.0,      1.0
    2028,                2028-01-01 01:00:00,     4380.0,     4380.0,      1.0
    2028,                2028-01-01 02:00:00,     4380.0,     4380.0,      1.0
    """
...
def test_add_snapshot_weightings_30_min_resolution(csv_str_to_df):
    ...
    input_csv = """
    investment_periods,  snapshots
    2026,                2026-01-01 00:30:00
    2026,                2026-01-01 01:00:00
    2026,                2026-01-01 01:30:00
    2026,                2026-01-01 02:00:00
    2026,                2026-01-01 02:30:00
    2026,                2026-01-01 03:00:00
    """
    ...
    expected_csv = """
    investment_periods,  snapshots,               objective,  generators,  stores
    2026,                2026-01-01 00:30:00,     1460.0,     1460.0,      0.5
    2026,                2026-01-01 01:00:00,     1460.0,     1460.0,      0.5
    2026,                2026-01-01 01:30:00,     1460.0,     1460.0,      0.5
    2026,                2026-01-01 02:00:00,     1460.0,     1460.0,      0.5
    2026,                2026-01-01 02:30:00,     1460.0,     1460.0,      0.5
    2026,                2026-01-01 03:00:00,     1460.0,     1460.0,      0.5
    """
...
def test_add_snapshot_weightings_240_min_resolution(csv_str_to_df):
    ...
    investment_periods,  snapshots
    2026,                2026-01-01 04:00:00
    2026,                2026-01-01 08:00:00
    2026,                2026-01-01 12:00:00
    2028,                2028-01-01 04:00:00
    """
    ...
    expected_csv = """
    investment_periods,  snapshots,               objective,  generators,  stores
    2026,                2026-01-01 04:00:00,     2920.0,     2920.0,      4.0
    2026,                2026-01-01 08:00:00,     2920.0,     2920.0,      4.0
    2026,                2026-01-01 12:00:00,     2920.0,     2920.0,      4.0
    2028,                2028-01-01 04:00:00,     8760.0,     8760.0,      4.0
    """
...
def test_add_snapshot_weightings_single_investment_period(csv_str_to_df):
    ...
    expected_csv = """
    investment_periods,  snapshots,               objective,  generators,  stores
    2030,                2030-01-01 01:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 02:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 03:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 04:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 05:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 06:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 07:00:00,     1095.0,     1095.0,      1.0
    2030,                2030-01-01 08:00:00,     1095.0,     1095.0,      1.0
    """
