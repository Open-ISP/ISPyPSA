...
def test_create_plot_suite(csv_str_to_df):
    """Test create_plot_suite with minimal representative data."""
    ...
    Gen1,      Coal,      S1,   100,         2030,              2050
    Gen2,      Wind,      S2,   50,          2030,              2050
    """
    ...
    # 3. Verify key output paths exist
    expected_paths = [
        # Transmission
        "transmission/aggregate_capacity.html",
        # Regional Expansion
        ...
        "generation/aggregate_capacity.html",
        "generation/regional/R1.html",
        "generation/regional/R2.html",
        "generation/sub_regional/S1.html",
