...
When enabled, the task will create and save a suite of plots to the `{run_directory}/{run_name}/outputs/capacity_expansion_plots/` directory.
...
- Tabular results from capacity expansion model in `{run_directory}/{run_name}/outputs/capacity_expansion_tables/` (generated by `create_and_run_capacity_expansion_model`)

**Outputs:**

- Plot files (interactive HTML format) in `{run_directory}/{run_name}/outputs/capacity_expansion_plots/`
- Results viewer website: `{run_directory}/{run_name}/outputs/capacity_expansion_results_viewer.html`
...
- Operational optimization results in `{run_directory}/{run_name}/outputs/operational.nc`
...
When enabled, the task will create and save a suite of plots to the `{run_directory}/{run_name}/outputs/operational_plots/` directory.
...
- Tabular results from operational model in `{run_directory}/{run_name}/outputs/operational_tables/` (generated by `create_and_run_operational_model`)

**Outputs:**

- Plot files (interactive HTML format) in `{run_directory}/{run_name}/outputs/operational_plots/`
- Results viewer website: `{run_directory}/{run_name}/outputs/operational_results_viewer.html`
